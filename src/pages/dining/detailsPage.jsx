...
const DiningDetail = () => {
  ...
  const { data, error, loading } = useFetch(`${import.meta.env.VITE_FETCH_URL}/api/dining/${slug}`);

  useEffect(() => {
    document.title = `CityScouts | Dining Details`;
  }, []);
    ...
    return (
      <div className="min-h-screen bg-gray-900 pt-24 pb-12 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">Loading Dining details...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-900 pt-24 pb-12 flex items-center justify-center">
        <div className="text-center py-12 bg-gray-800 rounded-lg shadow-sm border border-gray-700 max-w-md mx-auto">
          ...
          <h3 className="text-xl font-bold text-white mb-2">Dining not found</h3>
          <p className="text-gray-400 mb-6">
            The Dining you're looking for may have been removed or doesn't exist.
          </p>
          <Link
            to="/dinings"
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <span className="text-gray-200 text-sm">
                        {data.address || data.location?.address || 'N/A'}
                      </span>
                    </div>
                    <div>
